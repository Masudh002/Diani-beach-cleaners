...
const Footer = () => {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col bg-primary sm:mx-4 rounded-t-lg`} >
                ...
                <div className={`flex flex-col ss:my-0 my-4 min-w-[150px]`}>
                    ...
                    <ul  className="list-none mt-4">
                        {footerLink.links.map((link,index) =>(
                            <li  className={`font-poppins font-normal text-[16px] leading-[24px] text-dimWhite hover:text-blue-200 cursor-pointer ${
