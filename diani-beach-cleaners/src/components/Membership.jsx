...
const Membership = () => {
  return (
    <section id='member' className=' bg-blue-100 sm:m-4 my-2 rounded-lg'>
      ...
      <div className={`${layout.section} sm:m-4 my-2 rounded-lg gap-12`}>
         <div>
             ...
             <div>
                ...
                {organizers.map((organizer) =>(
                    <div key={organizer.id} className=''>
                        <div className='flex flex-row px-10 rounded-[20px]  max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card'>
